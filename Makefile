...
/* $(WARNING_GENERATED_FILE) */' $(TESTSUITE_HEADER)
	@ $(SED) -i 's|DEFAULT_MATHJAX_PATH|$(MATHJAX_TEST_PUBLIC_URI)$(DEFAULT_MATHJAX_BRANCH)|' $(TESTSUITE_HEADER)
...
runSeleniumHub:
	...
	@ cd testRunner/; $(JAVA) -jar seleniumServer.jar -role hub -port $(SELENIUM_SERVER_HUB_PORT)
